...
#### _Creates a Database with easy organizational tools for students and courses, February 2016_

#### By _**Jason Wuerch**_

## Description

_This app allows the user to create courses and students under those courses using many-to-many relationships and join statements._
